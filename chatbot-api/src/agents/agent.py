...
tools = [
    StructuredTool(
        ...
        description="""
                        อธิบายช่วยเหลือ การให้ข้อมูล ความรู้ แนะนำ โดนใช้ข้อมูลเกี่ยวข้องกับคำพิพากษาหรือกรณีศึกษาในหัวข้อเดียวกันหรือมีความคล้ายคลึงกับ การเช่าซื้อรถยนต์ การทำสัญญา
                        โดยเน้นการระบุข้อมูลเป็น string โดนสรุปรวมจาก เลขที่ของคำพิพากษา หรือคดีของคำพิพากษาษา ประเด็นข้อพิพาท กฎหมายที่เกี่ยวข้อง วิธีการดำเนินคดี

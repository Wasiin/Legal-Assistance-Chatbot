...
tools = [
    StructuredTool(
        ...
        description="""
                        อธิบายช่วยเหลือ การให้ข้อมูล ความรู้ แนะนำ โดนใช้ข้อมูลเกี่ยวข้องกับคำพิพากษาหรือกรณีศึกษาในหัวข้อเดียวกันหรือมีความคล้ายคลึงกับ โดยค้นหาจากเลขที่ของคำพิพากษา หรือคดีของคำพิพากษาษาได้
                        โดยเน้นที่ การเช่าซื้อรถยนต์ การทำสัญญา โดยเน้นการระบุข้อมูลเป็น string การหาข้อมูลด้วยเลขที่ของคำพิพากษา หรือคดีของคำพิพากษาษา โดนสรุปรวมจาก เลขที่ของคำพิพากษา หรือคดีของคำพิพากษาษา ประเด็นข้อพิพาท กฎหมายที่เกี่ยวข้อง วิธีการดำเนินคดี
                        และผลคำพิพากษา เพื่อนำข้อมูลที่ได้มาวิเคราะห์ เปรียบเทียบ และสร้างคำตอบที่ครอบคลุมและสอดคล้องกับประเด็นที่ต้องการศึกษา
